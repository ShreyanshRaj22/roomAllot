...
const Avarooms = () => {
    ...
    useEffect(() => {
        ...
        const fetchRooms = async () => {
          try {
            const response = await fetch('http://localhost:5000/api/countRooms');
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        {rooms.map(room => (
          <div className="col-lg-2 col-6" key={room.num} style={{ border: '1px solid black', padding: '10px', margin: '5px' }}>
